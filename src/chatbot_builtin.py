...
from .text_processor_builtin import TextProcessorBuiltin
from .simple_model_builtin import SimpleLanguageModelBuiltin

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger(__name__)

class BookWritingChatbotBuiltin:
    """
    AI Chatbot specialized for book writing assistance (Built-in Libraries Version).
    ...
    def __init__(self, model_path: Optional[str] = None, n_gram_size: int = 3):
        self.text_processor = TextProcessorBuiltin()
        self.model = SimpleLanguageModelBuiltin(n_gram_size=n_gram_size)
